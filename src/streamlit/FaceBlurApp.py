...
class FaceBlurApp:
    ...
    def run(self):
        ...
        if uploaded_image is not None:
            ...
            input_image, faces = self.__generateFaceBlurRect(image, detections, detection_threshold)
    ...
    def __generateFaceBlurRect(self, image, detections, threshold):
        ...
        for i in range(detections.shape[2]):
            ...
            if confidence >= threshold:
                ...
                selected_faces_data.append(['Face ' + str(face_count), x1, y1, x2, y2])
                face_count += 1
        
        return input_image, selected_faces_data
